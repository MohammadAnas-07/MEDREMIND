...
const authenticate = async ()=>{
  ...
  const auth = await LocalAuthentication.authenticateAsync({
    promptMessage: hasHardware && hasBiometrics ? 'Use face ID/TouchID' : 'Enter your PIN to access your medications',
  ...
  return(
    <LinearGradient colors={["#3f403fff","#033b05ff"]} style={styles.container}>
